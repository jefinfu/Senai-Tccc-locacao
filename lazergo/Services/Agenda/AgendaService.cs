    ...
    public class AgendaService : IAgendaInterface
    {
...

        {
            try
            {
                ...
                var agenda = new AgendaModel
                {
                    ...
                    ProprietarioTer = agendaCriacaoDto.ProprietarioTer,
                    CEPTer = agendaCriacaoDto.CEPTer,
                    EnderecoTer = agendaCriacaoDto.EnderecoTer,
                    UFTer = agendaCriacaoDto.UFTer,
                    BairroTer = agendaCriacaoDto.BairroTer,
                    NumeroTer = agendaCriacaoDto.NumeroTer,
                    CidadeTer = agendaCriacaoDto. CidadeTer,
                    CelularTer = agendaCriacaoDto.CelularTer
        ...
        public async Task<AgendaModel> EditarAgenda(AgendaModel agendaModel, List<IFormFile>? fotos)
        {
            try
            {
                ...
                agendaBanco.ProprietarioTer = agendaModel.ProprietarioTer;
                agendaBanco.EnderecoTer = agendaModel.EnderecoTer;
                agendaBanco.CEPTer = agendaModel.CEPTer;
                agendaBanco.CidadeTer = agendaModel.CidadeTer;
                agendaBanco.BairroTer = agendaModel.BairroTer;
                agendaBanco.UFTer = agendaModel.UFTer;
                agendaBanco.CelularTer = agendaModel.CelularTer;   
                agendaModel.NumeroTer = agendaModel.NumeroTer;
        ...
        public async Task AtualizarAgenda(AgendaModel agenda)
        {
            try
            {
